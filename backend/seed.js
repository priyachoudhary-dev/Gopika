/**
 * GOPIKA — Database Seed Script
 * Usage: node seed.js   (run from /backend directory)
 * Seeds 18 Indian ethnic wear products + 2 demo users
 */
...
const products = [
  // ── DRESSES ──────────────────────────────────────────────
  {
    ...
    description: "Floor-length Anarkali gown in lush rani pink georgette with hand-embroidered silver sequin flowers on the yoke. Flared skirt with layered silhouette, matching organza dupatta and silver lace border. Perfect for weddings and sangeet nights.",
    price: 5499, discountedPrice: 3999, category: "Dress",
    images: [{ public_id: "dress_anarkali", url: "https://images.unsplash.com/photo-1610030469983-98e550d6193c?auto=format&fit=crop&w=700&q=80" }],
  ...
  },
  {
    ...
    images: [{ public_id: "dress_ivory", url: "https://images.unsplash.com/photo-1566479179817-2c54a4e2f7a3?auto=format&fit=crop&w=700&q=80" }],
  ...
  },
  {
    ...
    images: [{ public_id: "dress_terracotta", url: "https://images.unsplash.com/photo-1583391733956-3750e0ff4e8b?auto=format&fit=crop&w=700&q=80" }],
  ...
  // ── KURTAS ───────────────────────────────────────────────
  {
    ...
    images: [{ public_id: "kurta_teal", url: "https://images.unsplash.com/photo-1608748010899-18f300247112?auto=format&fit=crop&w=700&q=80" }],
  ...
  },
  {
    ...
    images: [{ public_id: "kurta_phulkari", url: "https://images.unsplash.com/photo-1571513722275-4b41940f54b8?auto=format&fit=crop&w=700&q=80" }],
  ...
  },
  {
    ...
    images: [{ public_id: "kurta_angrakha", url: "https://images.unsplash.com/photo-1512436991641-6745cdb1723f?auto=format&fit=crop&w=700&q=80" }],
  ...
  // ── SAREES ───────────────────────────────────────────────
  {
    ...
    description: "Heirloom-worthy Royal Navy Banarasi pure silk saree with traditional gold brocade weave. The pallu features peacock motifs in genuine zari thread. A showstopper for weddings and puja ceremonies.",
    price: 10999, discountedPrice: 8499, category: "Saree",
    images: [{ public_id: "saree_banarasi", url: "https://images.unsplash.com/photo-1610030470298-40b8bbabc117?auto=format&fit=crop&w=700&q=80" }],
  ...
  },
  {
    ...
    images: [{ public_id: "saree_organza", url: "https://images.unsplash.com/photo-1594938298603-c8148c4b4f4f?auto=format&fit=crop&w=700&q=80" }],
  ...
  },
  {
    ...
    images: [{ public_id: "saree_linen", url: "https://images.unsplash.com/photo-1582750433449-648ed127bb54?auto=format&fit=crop&w=700&q=80" }],
  ...
  // ── CO-ORD SETS ──────────────────────────────────────────
  {
    ...
    description: "Relaxed-chic blush pink co-ord set in premium Irish linen. Pintuck tunic top pairs with wide-leg trousers. The neutral minimalist palette makes it infinitely versatile — dress it up or down.",
    price: 2599, discountedPrice: 1999, category: "Co-Ord Set",
    images: [{ public_id: "coord_blush", url: "https://images.unsplash.com/photo-1595777457583-95e059d581b8?auto=format&fit=crop&w=700&q=80" }],
  ...
  },
  {
    ...
    images: [{ public_id: "coord_sage", url: "https://images.unsplash.com/photo-1554568218-0f1715e72254?auto=format&fit=crop&w=700&q=80" }],
  ...
  // ── LEHENGA ──────────────────────────────────────────────
  {
    ...
    images: [{ public_id: "lehenga_emerald", url: "https://images.unsplash.com/photo-1609741199060-2a25ff2b3b1e?auto=format&fit=crop&w=700&q=80" }],
  ...
  },
  {
    ...
    images: [{ public_id: "lehenga_dusty", url: "https://images.unsplash.com/photo-1614886137799-d87f4eadcf5a?auto=format&fit=crop&w=700&q=80" }],
  ...
  // ── TOPS ─────────────────────────────────────────────────
  {
    ...
    images: [{ public_id: "top_saffron", url: "https://images.unsplash.com/photo-1485462537746-965f3b9f3eba?auto=format&fit=crop&w=700&q=80" }],
  ...
  },
  {
    ...
    images: [{ public_id: "top_bandhani", url: "https://images.unsplash.com/photo-1551488831-00ddcb6c6bd3?auto=format&fit=crop&w=700&q=80" }],
  ...
  // ── ACCESSORIES ──────────────────────────────────────────
  {
    ...
    images: [{ public_id: "acc_juttis", url: "https://images.unsplash.com/photo-1543163521-1bf539c55dd2?auto=format&fit=crop&w=700&q=80" }],
  ...
  },
  {
    ...
    description: "Rose gold Maang Tikka with Polki diamond accents and ruby-red meenakari florals. Adjustable chain with secure hook closure. Bridal-grade accessory that transforms any ethnic look into regal.",
    price: 1399, discountedPrice: 1099, category: "Accessories",
    images: [{ public_id: "acc_tikka", url: "https://images.unsplash.com/photo-1602808804648-4ab30e7823fe?auto=format&fit=crop&w=700&q=80" }],
  ...
  },
  {
    ...
    images: [{ public_id: "acc_potli", url: "https://images.unsplash.com/photo-1548036328-c9fa89d128fa?auto=format&fit=crop&w=700&q=80" }],
